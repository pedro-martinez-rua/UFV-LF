...
const Messages = () => {
  ...
  // "me" = student (you) interacting in the chat
  // "other" = other user
  ...
  > = {
    ...
    "3": [
      ...
      { id: 5, sender: "me", text: "No problem, happy to help", time: "09:18" },
      {
        id: 6,
        sender: "other",
        text: "Can we meet at the square at 10:00?.",
        time: "09:20",
      },
  ...
  if (!selectedChatId) {
    return (
      <div className="min-h-screen flex flex-col bg-background">
        {/* Sticky header */}
        <header className="sticky top-0 z-50 gradient-primary text-primary-foreground p-4 shadow-elevated">
      ...
      <header className="sticky top-0 z-50 gradient-primary text-primary-foreground p-4 shadow-elevated">
        <div className="max-w-md mx-auto flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-[11px] text-primary-foreground/60 mt-1 line-clamp-1">
              Last message: {lastMessageInCurrentChat || "No messages yet"}
            </p>
          </div>
        </div>
      </header>
